...
const Image: FC<IProps> = (props) => {
  ...
  const toolbarRender = (_node: ReactElement, info: Omit<ToolbarRenderInfoType, 'current' | 'total'>): ReactElement => {
    const {
      actions: {
        onFlipY,
        onFlipX,
    ...
    return (
      <div className='ant-image-preview-operations'>
        ...
        <Tooltip
          title='Уменьшить'
        >
          <div className={cn('ant-image-preview-operations-operation', {
